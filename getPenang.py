...
if __name__ == '__main__':
    ...
    for i in range(numberOfPages + 1):
        url = f"https://www.tripadvisor.com.my/Restaurants-g660694-oa{start}-Penang_Island_Penang.html#EATERY_LIST_CONTENTS"
        ...
        for div in infoContainers:
            ...
            print(attrs)
            penangData.append(attrs)
        start += 30

    df = pd.DataFrame(penangData)
    df.to_excel("PenangData.xlsx", index=False)
