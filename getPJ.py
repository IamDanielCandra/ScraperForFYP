...
if __name__ == '__main__':
    ...
    for i in range(numberOfPages + 1):
        url = f"https://www.tripadvisor.com.my/RestaurantSearch-g298313-oa{start}-a_geobroaden.false-Petaling_Jaya_Petaling_District_Selangor.html#EATERY_LIST_CONTENTS"
    ...
    df = pd.DataFrame(pjData)
    df.to_excel("PJData.xlsx", index=False)
